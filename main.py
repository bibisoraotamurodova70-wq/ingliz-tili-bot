...
def test_sending_loop():
    ...
    while True:
        try:
            ...
            msg = bot.send_message(chat_id=GROUP_CHAT_ID, text=f"🇬🇧 **{word}** — so'zining to'g'ri tarjimasini toping:", reply_markup=markup, parse_mode="Markdown")
